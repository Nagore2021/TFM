...
def main():
    ...
    if torch.cuda.is_available():
        ...
        st.warning("⚠️ GPU no detectada. Ejecutando en CPU")
    
    # Aviso médico
    st.markdown(
        '<div class="medical-warning">'
        '<strong>AVISO MÉDICO / OHAR MEDIKOA:</strong><br>'
        'Sistema de información médica de Osakidetza para orientación general. '
        '<strong>No sustituye la consulta médica profesional.</strong><br>'
